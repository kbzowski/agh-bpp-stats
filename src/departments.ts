...
export const departments: Department[] = [{
  ...
  'department_name': 'Wydział Elektrotechniki, Automatyki, Informatyki i Inżynierii Biomedycznej',
  'id_department': 31,
}, {
  ...
  'department_name': 'Szkoła Ochrony i Inżynierii Środowiska im. Walerego Goetla',
  'id_department': 23,
}, {
